    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _yield$Promise$all2$3 = _slicedToArray(_yield$Promise$all2[2], 1);
          rowsPro = _yield$Promise$all2$3[0];
          _yield$Promise$all2$4 = _slicedToArray(_yield$Promise$all2[3], 1);
          rowsOfe = _yield$Promise$all2$4[0];
          _yield$Promise$all2$5 = _slicedToArray(_yield$Promise$all2[4], 1);
          rowsUbi = _yield$Promise$all2$5[0];
          _yield$Promise$all2$6 = _slicedToArray(_yield$Promise$all2[5], 1);
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          _yield$Promise$all4$ = _slicedToArray(_yield$Promise$all4[0], 1);
          rowsBar = _yield$Promise$all4$[0];
          _yield$Promise$all4$2 = _slicedToArray(_yield$Promise$all4[1], 1);
          rowsSer = _yield$Promise$all4$2[0];
          _yield$Promise$all4$3 = _slicedToArray(_yield$Promise$all4[2], 1);
          rowsPro = _yield$Promise$all4$3[0];
          _yield$Promise$all4$4 = _slicedToArray(_yield$Promise$all4[3], 1);
          rowsOfe = _yield$Promise$all4$4[0];
          _yield$Promise$all4$5 = _slicedToArray(_yield$Promise$all4[4], 1);
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          _yield$Promise$all6$ = _slicedToArray(_yield$Promise$all6[0], 1);
          rowsBar = _yield$Promise$all6$[0];
          _yield$Promise$all6$2 = _slicedToArray(_yield$Promise$all6[1], 1);
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 4:
          ...
          _yield$Promise$all8$ = _slicedToArray(_yield$Promise$all8[0], 1);
          rowsBar = _yield$Promise$all8$[0];
          _yield$Promise$all8$2 = _slicedToArray(_yield$Promise$all8[1], 1);
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 4:
          ...
          _yield$Promise$all10$ = _slicedToArray(_yield$Promise$all10[0], 1);
          rowsBar = _yield$Promise$all10$[0];
          _yield$Promise$all10$2 = _slicedToArray(_yield$Promise$all10[1], 1);
